...
const FunatworkCategorydetails = () => {
  ...
  const [funatworkcategoryData, setfunatworkcategoryData] = useState([]);
  ...
  }, [funatworkcategoryData, filteredData]);
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "20px" }}>
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`delete_funatworkcategory/${id}`, {
                    headers: {
                  ...
                  setfunatworkcategoryData((prevCourses) => prevCourses.filter(course => course.id !== id));
      ...
      cell: (row) => (
        <div className="d-flex">
          <OverlayTrigger placement="top" overlay={<Tooltip id="edit-tooltip">Edit</Tooltip>}>
            <Button className="ms-1" onClick={() => navigate(`/update-funatworkcategory/${row.id}`, { state: row })}>
              <FaEdit />
            </Button>
          </OverlayTrigger>
            ...
            <Card.Header>
              <Row>
                <Col className="d-flex align-items-center">
                  <h5>Fun at Work Category <span className="highlight"> List</span></h5>
                </Col>
              ...
              <Row className="mt-3">
                <Col className="d-flex justify-content-end">
                  <Button variant="primary" onClick={handleAddfunatworkCategory}>
                    <FaPlus /> Add Fun Work Category
                  </Button>
                </Col>
              </Row>
            </Card.Header>
...
export default FunatworkCategorydetails;
