    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data?.status === "Success") {
                toast.success("Recognition category added successfully!");
                ...
                toast.error("Failed to add recognition category.");
            }
        } catch (err) {
            console.error("Error uploading recognition category:", err);
        }
    };
