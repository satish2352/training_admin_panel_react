  ...
  return (
    <>
      <div className="container backimg" ref={contentRef}>
                      ...
                      <Row>
                        ...
                        <Col lg={3} md={3} sm={12} className='mb-3'>
                          <Form.Group className="fname" controlId="exampleForm.ControlInput1">
                            <Form.Control type="text" className='FormStyeling transparent-input' value={husband_name} readOnly
                            />
                          </Form.Group>
                        ...
                        <Col lg={3} md={3} sm={12} className='mb-3'>
                          <Form.Group className="fname" controlId="exampleForm.ControlInput1">
                            <Form.Control type="text" className='FormStyeling transparent-input' value={HusbandOccupation} readOnly
                               />
                          </Form.Group>
                        ...
                        <Col lg={3} md={3} sm={12} className='mb-3'>
                          <Form.Group className="fname" controlId="exampleForm.ControlInput1">
                            <Form.Control type="text" className='FormStyeling transparent-input' value={Husband_contactdetails} readOnly
                            />
                          </Form.Group>
                        ...
                        <Col lg={3} md={3} sm={12} className='mb-3'>
                          <Form.Group className="fname" controlId="exampleForm.ControlInput1">
                            <Form.Control type="text" className='FormStyeling transparent-input' value={Husband_aadharno} readOnly
                            ></Form.Control>
                          </Form.Group>
        ...
        <Container fluid>
          <Card style={{ backgroundColor: "transparent", border: "none" }} ref={internshipRef} >
            <Card.Header
              className="cardpersonal_details"
              style={{ backgroundColor: "transparent", border: "none" }}
            >
...
export default AllDetailsofIntern;