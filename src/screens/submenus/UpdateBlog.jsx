...
const UpdateBlog = () => {
    ...
    const [image, setImage] = useState(blogs.images || null);
    const [preview, setPreview] = useState(blogs.images || null);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${BASE_URL}/update-blog-details`, payload, {
                headers: {
                                        ...
                                        <Container>
                                            <div className="text-start title-container">
                                                <b className="title-text fs-2">
                                                    UPDATE <span className="highlight">Blogs</span>
                                                </b>
                                            </div>
                                        </Container>
