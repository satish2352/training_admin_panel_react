...
const Newsdetails = () => {
  ...
  const fetchnewsData = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${BASE_URL}/get_news`, {
        headers: {
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "20px" }}>
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`delete_news/${id}`, {
                    headers: {
                  ...
                  setnewsData((prevCourses) => prevCourses.filter(course => course.id !== id));
      ...
      cell: (row) => (
        <div className="d-flex">
          <OverlayTrigger placement="top" overlay={<Tooltip id="edit-tooltip">Edit</Tooltip>}>
            <Button className="ms-1" onClick={() => navigate(`/update-newsdetails/${row.id}`, { state: row })}>
              <FaEdit />
            </Button>
          </OverlayTrigger>
            ...
            <Card.Header>
              <Row>
                <Col className="d-flex align-items-center">
                  <h5>News Details  <span className="highlight"> List</span></h5>
                </Col>
