...
const AddHiring = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${BASE_URL}/add_hired`, payload, {
                headers: {
            ...
            if (response.data?.status === "Success") {
                ...
                toast.error("Failed to add hiring.");
            }
        } catch (err) {
                                        ...
                                        <Container>
                                            <div className="text-start title-container">
                                                <b className="title-text fs-2">
                                                    ADD <span className="highlight">HIRING</span>
                                                </b>
                                            </div>
                                        </Container>
                                        <Button className="me-3 fs-5 text-nowrap"
                                            style={{ whiteSpace: "nowrap" }} variant="secondary" onClick={() => navigate('/hiredetails')}>
                                            Hiring Details
                                        </Button>
                                    </div>
                                </Card.Header>
