...
const AddBlog = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${BASE_URL}/add-blog-details`, payload, {
                headers: {
                                        ...
                                        <Container>
                                            <div className="text-start title-container">
                                                <b className="title-text fs-2">
                                                    ADD <span className="highlight">Blog</span>
                                                </b>
                                            </div>
                                        </Container>
                                        <Button className="me-3 fs-5 text-nowrap"
                                            style={{ whiteSpace: "nowrap" }} variant="secondary" onClick={() => navigate('/blogs')}>
                                            Blog Details
                                        </Button>
                                    </div>
                                </Card.Header>
