...
const MOUCategorydetails = () => {
  ...
  const [moucategoryData, setmoucategoryData] = useState([]);
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "20px" }}>
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`delete_moucategory/${id}`, {
                    headers: {
      ...
      cell: (row) => (
        <div className="d-flex">
          <OverlayTrigger placement="top" overlay={<Tooltip id="edit-tooltip">Edit</Tooltip>}>
            <Button className="ms-1" onClick={() => navigate(`/update-moucategory/${row.id}`, { state: row })}>
              <FaEdit />
            </Button>
          </OverlayTrigger>
            ...
            <Card.Header>
              <Row>
                <Col className="d-flex align-items-center">
                  <h5>MOU Category <span className="highlight"> List</span></h5>
                </Col>
              ...
              <Row className="mt-3">
                <Col className="d-flex justify-content-end">
                  <Button variant="primary" onClick={handleAddMOUCategory}>
                    <FaPlus /> Add MOU Category
                  </Button>
                </Col>
              </Row>
            </Card.Header>
...
export default MOUCategorydetails;
